...
lines.append('')
lines.append('        # BODY PRIORITY: if a body bone is within 2x the closest bone distance,')
lines.append('        # this vertex belongs to the body, not a leg.')
lines.append('        # Chitin body plates are large — they win ties against nearby leg coxa bones.')
lines.append('        if best_group != "body" and body_bone and body_dist < best_dist * 2.5:')
