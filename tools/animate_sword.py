...
ANIMS['sword_light'] = {
    ...
    'right': [
        ...
        (22, (-1.10, 1.8, -0.80), (-0.55, 0.75, -0.35), (-0.70, 0.20, -0.68), 'grip_loose'),
        (32, *READY, 'grip'),
    ],
...
ANIMS['sword_heavy'] = {
    ...
    'right': [
        ...
        (16, (1.30, 0.4, 3.10), (-0.15, 0.55, 0.82), (0.00, -0.75, 0.66), 'grip_tight'),
        (26, (1.28, 0.38, 3.15), (-0.15, 0.53, 0.83), (0.00, -0.76, 0.65), 'grip_tight'),
        (28, (1.20, 1.3, 2.60), (-0.12, 0.95, 0.28), (0.05, -0.28, 0.96), 'grip_tight'),  # guide: blade sweeping over
        (30, (1.10, 2.9, 0.10), (-0.10, 0.85, -0.52), (0.00, 0.60, -0.80), 'grip_tight'),
        (33, (1.15, 2.7, -0.10), (-0.10, 0.83, -0.55), (0.00, 0.57, -0.82), 'grip_tight'),
...
ANIMS['sword_thrust'] = {
    ...
    'right': [
        (1,  *READY, 'grip'),
        (9,  (2.35, 0.2, 0.00), (0.00, 0.55, -0.835), (0.00, 1.00, 0.00), 'grip_tight'),
        (13, (2.40, 0.1, 0.02), (0.00, 0.55, -0.835), (0.00, 1.00, 0.00), 'grip_tight'),
        (17, (1.10, 3.4, -0.40), (-0.02, 0.55, -0.835), (0.00, 1.00, 0.00), 'grip_tight'),
        (22, (1.90, 1.2, -0.10), (-0.05, 0.60, -0.80), (0.00, 1.00, 0.10), 'grip'),
        (32, *READY, 'grip'),
    ],
...
ANIMS['sword_parry'] = {
    ...
    'right': [
        ...
        (24, (1.50, 1.7, 0.50), (-0.20, 0.87, -0.45), (0.00, 0.50, 0.87), 'grip'),
        (38, (1.52, 1.68, 0.48), (-0.20, 0.87, -0.45), (0.00, 0.50, 0.87), 'grip'),
    ],
